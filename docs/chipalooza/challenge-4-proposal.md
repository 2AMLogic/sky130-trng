...
- ~~**Synthesize the digital section** against `sky130_fd_sc_hd`. The
  ...
  record in this repository provides.~~ **Landed (issue #117,
  `sim/digital-synthesis/`).** Cell count, area and Liberty-summed leakage
